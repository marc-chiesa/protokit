...
- Deciding whether to fail-loud on an "exotic" proto type: check first whether the backend maps it **losslessly** (Any/Struct/FieldMask do, to structs); reserve fail-loud for genuine handler-build failure, raised before output.
