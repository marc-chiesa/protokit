...
- audit-wire-format-before-claiming-sibling-parity-2026-05-03 (maintainer-side learning, kept in the private learnings repository rather than this tree) — audit discipline for the corpus as a whole. The structural anchor is the executable form of "verify fixture labels match their contents before claiming the parity gate covers a given scenario."
