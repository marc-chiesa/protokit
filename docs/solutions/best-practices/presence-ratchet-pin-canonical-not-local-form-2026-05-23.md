...
- delivery-boundary-bundled-commit-feat-plus-review-followups-2026-05-21 — the bundled-commit discipline that governed how the D6e U4 follow-up fix landed (separate `fix(lint):` commit, since the U4 boundary at `82c9a3e` was already committed when ce:review ran).
