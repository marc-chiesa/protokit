...
- `src/protokit/formatters/_builtin_lint.py:_lint_rules_catalog` (post-fix lines ~698-741), introduced in commit `dfd5f87` (D6f U1 ce:review follow-ups)
