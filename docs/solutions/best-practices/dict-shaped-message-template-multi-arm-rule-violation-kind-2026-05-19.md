...
### Concrete pattern (D6c U2 R8b post-fix, commit `b281d3b`)
...
### Before (identity-template anti-pattern, D6c U2 initial drop, commit `7b9655e`)
...
### After (dict-shaped templates per arm, commit `b281d3b`)
