...
- D6b U4b ce:review run artifact: `.context/compound-engineering/ce-review/20260517-142846-d5fdc684/`, which is maintainer-local and not in this repo — adversarial reviewer's ADV-2 finding (0.82 confidence) that prompted the precondition addition.
