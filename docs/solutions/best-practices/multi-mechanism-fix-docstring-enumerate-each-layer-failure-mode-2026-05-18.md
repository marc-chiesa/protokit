...
class TestRulePackExplicitLoadIsIdempotent:
    ...
    frozenset-union at model.py:719-721 absorbs the duplicate rule_ids.
    """
```
...
class TestRulePackExplicitLoadIsIdempotent:
    ...
    3. **Profile-level frozenset union at model.py:719-721**
       (defense-in-depth):
